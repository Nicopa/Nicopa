	...
	return (
		<main>
			...
			>
				...
				<h3>Who I am</h3>
				<p>
					I&apos;m Nícolas (you can call me Nick) and I&apos;m a junior software
					developer. I&apos;m from{" "}
					<a
				...
				<p>
					...
					companies in my region. From the first project, I was always
				...
				<p>
					...
					how to make sushi. From scratch I started as an apprentice sushiman
					and after two years I opened my own restaurant. But in October 2021, I
					didn&apos;t get the financial independence I was looking for, so I
			...
			>
				...
				<p>
					...
					searching for equal cards, you have to find each evolution set of the
			...
			>
				...
				<p>
					...
					call me and we might schedule a meeting to talk about any questions or
					my Although I&apos;m not currently looking for any new opportunities,
